...
public class FlutterOverlayWindowPlugin implements
    ...
    public void onAttachedToEngine(@NonNull FlutterPluginBinding flutterPluginBinding) {
        ...
        // LOCAL PATCH: WindowSetup.messenger is static, and this plugin is registered on BOTH
        // engines (the app's and the cached overlay engine). Assigning it here meant the
        // overlay engine - registered last - won, so OverlayService forwarded shareData() from
        // the overlay straight back to the overlay instead of to the app. Only the engine that
        // owns an Activity is the app's, so the assignment moved to onAttachedToActivity.
    }
    ...
    public void onAttachedToActivity(@NonNull ActivityPluginBinding binding) {
        ...
        // LOCAL PATCH: see onAttachedToEngine. Only the app's engine gets an Activity, so this
        // is the one place where we know the messenger belongs to the app and not the overlay.
